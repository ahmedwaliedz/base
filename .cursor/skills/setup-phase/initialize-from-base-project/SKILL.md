---
name: initialize-from-base-project
description: Initialize a new project from this base project. Trigger when starting a new project or repository before any feature work.
---
