---
name: laravel-feature-end-to-end
description: Execute a full feature from analysis to delivery in one pass. Trigger for well-defined features that span multiple layers.
---
...
- Only orchestrate request â†’ service â†’ response
