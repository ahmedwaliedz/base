---
name: feature-to-module-execution
description: Map a feature to an existing or new module and define execution order. Trigger after feature analysis.
---
...
- `app/Services/Admin/Roles/RoleService.php`
...
**Decision:**
- **Extend existing?** â†’ Feature fits current module
- **Create new module?** â†’ Feature is new domain
...
| Routes | New routes in `routes/admin.php` or `routes/api/v1/<topic>.php` |
...
1. **Database** â†’ Migration first
2. **Model** â†’ Then model
3. **Form Request** â†’ Then validation
4. **Service** â†’ Then business logic
5. **Controller** â†’ Then orchestration
6. **Routes** â†’ Then routing
7. **Views** â†’ Then UI
8. **Translations** â†’ Then i18n
9. **Tests** â†’ Then tests
