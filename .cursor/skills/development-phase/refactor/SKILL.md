---
name: refactor
description: Improve code quality without changing behavior. Trigger for cleanup, duplication removal, or naming improvements.
---
...
- Duplication â†’ extract to shared method/trait/service
- Controller logic â†’ move to Service class
- Blade logic â†’ move to controller/service, keep Blade presentation-only
- Validation in controller â†’ move to Form Request
- Long method â†’ split into smaller focused methods
- Poor naming â†’ rename following project conventions
...
- **Services:** `app/Services/Admin/` or `app/Services/{Domain}/` (e.g., `app/Services/Countries/`)
- **Form Requests:** `app/Http/Requests/`
- **Controllers:** `app/Http/Controllers/Admin/` or `app/Http/Controllers/Api/V1/`
