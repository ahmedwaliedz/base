---
name: create-api-with-postman
description: Build an API endpoint with validation, service, resource, and Postman documentation. Trigger for new or updated API endpoints.
---
...
- Use realistic values from:
  - seeders
  - factories
- If unavailable â†’ use realistic values
