...
<form id="editPostForm" class="mb-3 validated-form form" novalidate method="POST" action="{{ route('admin.posts.update', ['post' => $post]) }}" enctype="multipart/form-data">
    ...
    <div class="admins-form-section">
        <div class="row g-3">
            ...
            <x-form.select :options="['name' => 'is_active', 'label' => 'is_active', 'class' => 'col-md-12', 'isRequired' => true, 'value' => (int) $post->is_active, 'options' => [['id' => 1, 'name' => __('admin/main.yes')], ['id' => 0, 'name' => __('admin/main.no')]]]" />
        </div>
    </div>
    <div class="admins-form-section">
        <div class="row g-3">
