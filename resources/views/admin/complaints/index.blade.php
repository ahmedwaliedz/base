...
@push('content')
    <x-table.buttons createRoute="{{ route('admin.complaints.create') }}" :hasDeleteAll="true" :deleteAllRoute="route('admin.complaints.destroyAll')" :hasReload="true" :hasFilter="true" :hasSearch="true" :hasPagination="true" />
