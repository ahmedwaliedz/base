...
<form id="createFaqForm" class="mb-3 validated-form form" novalidate method="POST" action="{{ route('admin.faqs.store') }}" enctype="multipart/form-data">
    ...
    <div class="admins-form-section">
        <div class="row g-3">
            ...
            <x-form.text :options="['name' => 'question', 'label' => 'question', 'class' => 'col-md-12', 'isRequired' => true, 'isMultiLanguage' => true]" />
            <x-form.text-area :options="['name' => 'answer', 'label' => 'answer', 'class' => 'col-md-12', 'isRequired' => true, 'isMultiLanguage' => true]" />
        </div>
    </div>
