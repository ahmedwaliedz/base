...
<form id="editCityForm" class="mb-3 validated-form form" novalidate method="POST" action="{{ route('admin.cities.update', ['city' => $city]) }}" enctype="multipart/form-data">
    ...
    <div class="admins-form-section">
        <div class="row g-3">
            <x-form.select :options="['name' => 'region_id', 'label' => 'region', 'class' => 'col-md-12', 'isRequired' => true, 'value' => $city->region_id, 'options' => $regions]" />
    ...
    <div class="admins-form-section">
        <div class="row g-3">
            <x-form.text :options="['name' => 'name', 'label' => 'name', 'class' => 'col-md-12', 'isRequired' => true, 'isMultiLanguage' => true, 'value' => $city->getTranslationsArray()]" />
        </div>
    </div>
