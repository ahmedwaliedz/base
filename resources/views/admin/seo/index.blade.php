...
@push('content')
    ...
    <x-table.table :hasCheckbox="true" :hasActions="true" :headers="[__('admin/main.meta_title'), __('admin/main.meta_description'), __('admin/main.type'), __('admin/main.actions')]" />
@endpush