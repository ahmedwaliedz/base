...
<form id="createSeoForm" class="mb-3 validated-form form" novalidate method="POST" action="{{ route('admin.seo.store') }}" enctype="multipart/form-data">
    ...
    <div class="admins-form-section">
        <div class="row g-3">
            <x-form.text :options="['name' => 'meta_title', 'label' => 'meta_title', 'class' => 'col-md-12', 'isMultiLanguage' => true]" />
            <x-form.text-area :options="['name' => 'meta_description', 'label' => 'meta_description', 'class' => 'col-md-12', 'isMultiLanguage' => true]" />
            <x-form.text :options="['name' => 'meta_keywords', 'label' => 'meta_keywords', 'class' => 'col-md-12', 'isMultiLanguage' => true]" />
        </div>
    </div>
