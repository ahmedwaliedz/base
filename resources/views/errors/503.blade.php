...
<head>
    ...
    <title>{{ __('admin/main.service_unavailable') }} - 503</title>
...
<body>
    ...
    <div class="container-xxl py-4">
        <div class="misc-wrapper text-center">
            <div class="error-content mx-auto" style="max-width: 500px;">
                <h2 class="mb-3">{{ __('admin/main.service_unavailable') }}</h2>
                <p class="mb-4">{{ __('admin/main.temporarily_unavailable') }}</p>
                <p class="mb-4">{{ __('admin/main.maintenance_mode') }}</p>
            </div>
            <div class="position-relative">
                <lottie-player src="{{ asset('storage/uploads/settings/Maintenance.json') }}" background="transparent" speed="0.8" style="width: 250px; height: 250px; margin: 0 auto; position: relative; z-index: 2;" loop autoplay></lottie-player>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const numberOfDots = 150; // Increased number of dots for better visual effect
