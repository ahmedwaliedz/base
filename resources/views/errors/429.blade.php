...
<head>
    ...
    <title>{{ __('admin/main.too_many_requests') }} - 429</title>
    ...
    <div class="container-xxl py-4">
        <div class="misc-wrapper text-center">
            <div class="error-content mx-auto" style="max-width: 500px;">
                <h2 class="mb-3">{{ __('admin/main.too_many_requests') }}</h2>
                <p class="mb-4">{{ __('admin/main.too_many_attempts') }}</p>
            </div>
            <div class="position-relative">
                <lottie-player src="{{ asset('storage/uploads/settings/TooManyRequests.json') }}" background="transparent" speed="0.8" style="width: 250px; height: 250px; margin: 0 auto; position: relative; z-index: 2;" loop autoplay></lottie-player>
            </div>
