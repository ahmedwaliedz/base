...
<?php
    ...
    return [
        ...
        'export_selected_rows' => 'تصدير الصفوف المحددة',
        'export_current_page' => 'تصدير الصفحة الحالية',
        'export_all_filtered' => 'تصدير جميع الصفوف المفلترة',
        ...
        'home_card_view' => 'عرض',
        'home_card_view_complaints' => 'عرض الشكاوى',
        'home_card_view_contacts' => 'عرض رسائل التواصل',
        'home_card_view_categories' => 'عرض التصنيفات',
        'home_card_view_faqs' => 'عرض الأسئلة الشائعة',
        'home_card_view_posts' => 'عرض المقالات',
        'home_card_view_sliders' => 'عرض السلايدر',
        ...
        'replay' => 'الرد',
        'no_create_for_complaints' => 'الشكاوى مقدمة من المستخدمين فقط',
        'no_create_for_messages' => 'الرسائل مقدمة من المستخدمين فقط',
        'no_create_for_replays' => 'الردود مقدمة من المستخدمين فقط',
        'no_edit_for_complaints' => 'لا يمكن تعديل الشكاوى',
        'no_edit_for_messages' => 'لا يمكن تعديل الرسائل',
        'no_edit_for_replays' => 'لا يمكن تعديل الردود',
    ];
