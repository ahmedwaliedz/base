...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        // Parent multilingual arrays
        'ar'           => 'الحقول العربية',
        'en'           => 'الحقول الإنجليزية',

        // Notification
        'message'      => 'رسالة الإشعار',
        'message.*'    => 'رسالة الإشعار',
        'message.ar'   => 'رسالة الإشعار بالعربية',
        'message.en'   => 'رسالة الإشعار بالإنجليزية',
        'id'           => 'المعرف',
        'class'        => 'النوع',

        // Wildcard array entries
        'name.*'       => 'الاسم',
        'name.ar'      => 'الاسم بالعربية',
        'name.en'      => 'الاسم بالإنجليزية',
        'map_desc.*'   => 'وصف الخريطة',
        'map_desc.ar'  => 'وصف الخريطة بالعربية',
        'map_desc.en'  => 'وصف الخريطة بالإنجليزية',
        'permissions.*' => 'الصلاحية',
        'ids'          => 'المعرفات',
        'ids.*'        => 'المعرف',

        // Nested multilingual (ar[field] / en[field])
        ...
        'en.question'         => 'السؤال بالإنجليزية',
        'ar.answer'           => 'الإجابة بالعربية',
        'en.answer'           => 'الإجابة بالإنجليزية',
        'ar.meta_title'       => 'عنوان ميتا بالعربية',
        'en.meta_title'       => 'عنوان ميتا بالإنجليزية',
        'ar.meta_description' => 'وصف ميتا بالعربية',
        'en.meta_description' => 'وصف ميتا بالإنجليزية',
        'ar.meta_keywords'    => 'الكلمات المفتاحية بالعربية',
        'en.meta_keywords'    => 'الكلمات المفتاحية بالإنجليزية',

        // Setting-specific
        'whatsapp'          => 'رقم الواتساب',
        'logo'              => 'الشعار',
        'no_data_image'     => 'صورة عدم وجود بيانات',
        'fav_icon'          => 'الأيقونة المفضلة',
        'app_commission'    => 'عمولة التطبيق',
        'vat_ratio'         => 'نسبة الضريبة',
        'coupon_max_ratio'  => 'الحد الأقصى للكوبون',
        'map_desc'          => 'وصف الخريطة',
        'lat'               => 'خط العرض',
        'lng'               => 'خط الطول',
