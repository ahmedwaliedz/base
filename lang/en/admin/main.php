...
<?php
    ...
    return [
        ...
        'export_selected_rows' => 'Export selected rows',
        'export_current_page' => 'Export current page',
        'export_all_filtered' => 'Export all filtered rows',
        ...
        'home_card_view' => 'View',
        'home_card_view_complaints' => 'View complaints',
        'home_card_view_contacts' => 'View contact messages',
        'home_card_view_categories' => 'View categories',
        'home_card_view_faqs' => 'View FAQs',
        'home_card_view_posts' => 'View posts',
        'home_card_view_sliders' => 'View sliders',
        ...
        'coverage' => 'Coverage',
        'replay' => 'Reply',
        'no_create_for_complaints' => 'Complaints are user-submitted only',
        'no_create_for_messages' => 'Messages are user-submitted only',
        'no_create_for_replays' => 'Replies are user-submitted only',
        'no_edit_for_complaints' => 'Complaints cannot be edited',
        'no_edit_for_messages' => 'Messages cannot be edited',
        'no_edit_for_replays' => 'Replies cannot be edited',
    ];
