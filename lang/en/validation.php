...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'message.*'    => 'Notification Message',
        'message.ar'   => 'Notification Message in Arabic',
        'message.en'   => 'Notification Message in English',
        'id'           => 'ID',
        'class'        => 'Class',
        ...
        'map_desc.ar'  => 'Map Description in Arabic',
        'map_desc.en'  => 'Map Description in English',
        ...
        'vat_ratio'         => 'VAT Ratio',
        'coupon_max_ratio'  => 'Coupon Max Ratio',
        'map_desc'          => 'Map Description',
        'lat'               => 'Latitude',
        'lng'               => 'Longitude',
