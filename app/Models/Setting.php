...
class Setting extends Model implements HasMedia
{
    ...
    public function getValueAttribute($value)
    {
        return match ($this->type) {
            SettingTypeEnum::JSON => json_decode($value, true),
            SettingTypeEnum::ARRAY => (array) $value,
            SettingTypeEnum::INTEGER => (int) $value,
            SettingTypeEnum::BOOLEAN => (bool) $value,
            SettingTypeEnum::IMAGE => (string) $this->handleImagePath(
                file: $value,
